...
{
public:
  PicoDet(const char *param, const char *bin, int input_width, int input_hight, int class_num,
...
private:
  ...
  std::vector<NonPostProcessHeadInfo> non_postprocess_heads_info{
      ...
      {"save_infer_model/scale_0.tmp_0", "save_infer_model/scale_1.tmp_0", 8},
      {"save_infer_model/scale_2.tmp_0", "save_infer_model/scale_3.tmp_0", 16},
      {"save_infer_model/scale_4.tmp_0", "save_infer_model/scale_5.tmp_0", 32},
      {"save_infer_model/scale_6.tmp_0", "save_infer_model/scale_7.tmp_0", 64},
